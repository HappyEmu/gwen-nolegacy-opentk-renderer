...
namespace Gwen.Control
{
    ...
    public class ScrollBar : Base
    {
        ...
        public virtual float NudgeAmount { get => m_NudgeAmount / m_ContentSize; set => m_NudgeAmount = value; }
        public float ScrollAmount => m_ScrollAmount;
        public float ContentSize { get => m_ContentSize; set { if (m_ContentSize != value) { Invalidate(); } m_ContentSize = value; } }
        public float ViewableContentSize { get => m_ViewableContentSize; set { if (m_ViewableContentSize != value) { Invalidate(); } m_ViewableContentSize = value; } }
